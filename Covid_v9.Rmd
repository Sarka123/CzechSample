...
```{r PHQ8 descriptives, fig.width=9}
...
```{r sample demography descriptives, fig.width=9}
...
```{r theory-driven regression model}
...
```{r anxiety items descriptives, fig.width=9}
...
```{r anxiety items Exploratory Factor Analysis, fig.width=9}
...
```{r anxiety index creation and descriptives, fig.width=9}
...
```{r path diagram Hayes model 8, fig.width=9}
# Conceptual diagram
labels_H8 <- list(X = "Soc. Media",M = "Anxiety",Y = "Depression", W = "Age")
pmacroModel(8,labels = labels_H8)
```
